  ...
  <body>
    ...
    <nav class="bar bar-tab">
	  ...
	  <a class="tab-item external page3" href="?id=3">
	    ...
	    <span class="tab-label">微博管理</span>
	  </a>	  
	...
	<div class="content">
		<div class="content-padded" id="page1">
		  ...
		  <?php
		  	...
		  	$sql2="select * from user where ifAdmin=0";
		...
		<div class="content-padded" id="page2" style="display:none;">		  
			<div class="content">
				<div class="content">				  				  
				  <div class="content-block-title">用户列表</div>
				    	...
				    	?>
				    		<li class="item-content item-link">
						        ...
						        <div class="item-inner">
						          <div class="item-title"><?php echo $row2['username'];?></div>
						          <div class="item-after"><a href="user_xq.php?username=<?php echo $row2['username'];?>" class="link">详情</a></div>
						        </div>
						    </li>
				    	<?php
				    		}
		...
		<div class="content-padded" id="page3" style="display:none;">
		  <div class="content-block-title">微博管理</div>
		  <?php
		  	include('conn.php');
		  	$sql4="select * from wenzhang order by redu desc";
		  ...
		  ?>
		  	<div class="card facebook-card">
			    <div class="card-header no-border">
			      <div class="facebook-avatar"><img src="http://gqianniu.alicdn.com/bao/uploaded/i4//tfscom/i3/TB10LfcHFXXXXXKXpXXXXXXXXXX_!!0-item_pic.jpg_250x250q60.jpg" width="34" height="34"></div>
			      <div class="facebook-name"><?php echo $row4['wz_zuozhe'];?><span class="icon icon-remove shanchu" style="margin-left: 130px;font-size: 20px;" id="<?php echo $row4['wz_Id'];?>"></span></div>
			      <div class="facebook-date"><?php echo $row4['time'];?></div>
			    </div>
			    <div class="card-content content-padded" id="<?php echo $row['time'];?>">
			    	<?php echo $row4['content'];?>
			    </div>
			    <div class="card-footer no-border">
			      <a href="#" class="link">赞<?php echo $row4['dz_num'];?></a>
			      <a href="#" class="link">评论<?php echo $row4['pl_num'];?></a>
			      <a href="#" class="link">热度<?php echo $row4['redu'];?></a>
			    </div>
			  </div>
		  <?php
		  	}
	...
	<script type="text/javascript">
		...
		$('.dd').click(function(){
			...
			// alert(wz_Id);
			window.location.href="admin_Main2.php?wz_Id="+wz_Id;
		});
